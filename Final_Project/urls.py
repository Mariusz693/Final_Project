...
urlpatterns = [
    ...
    path('user_delete/<int:pk>/', views.UserLoginView.as_view(), name='user-delete'),
    path('user_edit/<int:id_user>/', views.UserLoginView.as_view(), name='user-edit'),
    # path('my_user_details/<int:id_my_user>/', views.MyUserDetailsView.as_view(), name='my-user-details'),
    path('user_password/<int:id_user>/', views.UserLoginView.as_view(), name='user-password'),
